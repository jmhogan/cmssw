...
#ifndef HitFit_ElectronTranslatorBase_h
#define HitFit_ElectronTranslatorBase_h
/*
...
//    template <> //Changed-------------------------
    ...
    public:
         ...
         */
        ElectronTranslatorBase(const std::string& ifile);
...
#endif // #ifndef HitFit_ElectronTranslatorBase_h
